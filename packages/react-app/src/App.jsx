...
function App(props) {
  ...
  const stakerContractBalance = useBalance(
    localProvider,
    readContracts && readContracts.StakingPool ? readContracts.StakingPool.address : null,
  );
  if (DEBUG) console.log("💵 stakerContractBalance", stakerContractBalance);

  // ** keep track of total 'threshold' needed of ETH
  const threshold = useContractReader(readContracts, "StakingPool", "threshold");
  ...
  const stakeEvents = useEventListener(readContracts, "StakingPool", "Stake", localProvider, 1);
  console.log("📟 stake events:", stakeEvents);

  // ** keep track of a variable from the contract in the local React state:
  const timeLeft = useContractReader(readContracts, "StakingPool", "timeLeft");
          ...
          <Route exact path="/">
            ...
            <div style={{ padding: 8 }}>
              <Button
                ...
                onClick={() => {
                  tx(writeContracts.StakingPool.stake({ value: ethers.utils.parseEther("0.5") }));
                }}
              >
                🥩 Stake 0.5 ether!
              </Button>
